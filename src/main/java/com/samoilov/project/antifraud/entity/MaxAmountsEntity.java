...
public class MaxAmountsEntity {
    ...
    @Column(name = "max_allowed_transaction_amount", columnDefinition = "BIGINT DEFAULT 200")
    private Long maxAllowedTransactionAmount;

    @Column(name = "max_manual_transaction_amount", columnDefinition = "BIGINT DEFAULT 1500")
